...
function Logear() {
    Swal.fire({
        ...
        footer: '<a href="#" id="restaurar-clave" style="color: #254C97; text-decoration: underline;">Olvide mi contraseña</a>',
    });
...
__VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (__VLS_ctx.Logear) }, key: ("login"), ...{ class: ("px-6 py-3 rounded-md focus:outline-none ml-8 m-10 bg-credi-blue text-white hover:bg-credi-blue transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110") }, });
...
// @ts-ignore
const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ to: ("/registrar"), ...{ class: ("text-credi-blue hover:text-credi-green transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110") }, }));
const __VLS_2 = __VLS_1({ to: ("/registrar"), ...{ class: ("text-credi-blue hover:text-credi-green transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
